...
if not AceEvent.events then
  AceEvent.events =
    CallbackHandler:New(AceEvent, 'RegisterEvent', 'UnregisterEvent', 'UnregisterAllEvents')
end
...
if not AceEvent.messages then
  AceEvent.messages =
    CallbackHandler:New(AceEvent, 'RegisterMessage', 'UnregisterMessage', 'UnregisterAllMessages')
