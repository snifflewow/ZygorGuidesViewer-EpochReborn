...
ZygorGuidesViewer_L('Faction', 'enUS', function()
  return {
    ['going'] = '%d%% to %s',
  }
end)
...
ZygorGuidesViewer_L('Specials', 'enUS', function()
  return {
    ...
    ['contract_mobs_start'] = function(s)
      return s .. ' mobs'
    end,
...
ZygorGuidesViewer_L('G_string', 'enUS', function()
  return {
    --	["blabla"] = TRUE,
  }
end)
