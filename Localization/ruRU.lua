...
ZygorGuidesViewer_L('Main', 'ruRU', function()
  return {
    ...
    ['minimap_tooltip'] = COLOR_TIP_MOUSE
      .. 'Click|r to toggle guide window|n'
      .. COLOR_TIP_MOUSE
      .. 'Right-click|r to configure|n', --..COLOR_TIP_MOUSE.."Drag|r to move icon"
    ...
    ['tooltip_waypoint'] = COLOR_TIP_MOUSE
      .. 'Click|r'
      .. COLOR_TIP
      .. ' to set waypoint: |cffffaa00%s|r',
...
ZygorGuidesViewer_L('Specials', 'ruRU', function()
  return {
...
ZygorGuidesViewer_L('G_string', 'ruRU', function()
  return {
    --	["blabla"] = TRUE,
  }
end)
